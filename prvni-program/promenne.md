...
Proměnná :var[document.body.innerHTML] je trochu speciální. Tuto proměnnou vytvářet nemusíme, protože už ji pro nás vytvořil prohlížeč při načtení stránky. Nepíšeme tedy před ni `const`. Tato proměnná obsahuje celý obsah naší stránku a jejím nastavním můžem obsah stránky měnit.
